...
include {hisat2_build; hisat2_splice_sites; hisat2_align} from "$baseDir/../../luslab-nf-modules/tools/hisat2/main.nf"
...
workflow {
    ...
    hisat2_align ( params.modules['hisat2'], cutadapt.out.fastq, hisat2_build.out.genome_index.collect(), hisat2_splice_sites.out.splice_sites.collect() )
